...
def build_report(cfg, timeline, clips, narration_path, music_path, output_path,
    ...
    return {
        ...
        "audio": {
            ...
            "music_enabled": bool(cfg.get("music_enabled", True) and music_path
                                  and os.path.isfile(music_path)),
            "music_volume": cfg.get("music_volume"),
            "ducking_enabled": cfg.get("ducking_enabled"),
            "clip_audio_enabled": cfg.get("clip_audio_enabled"),
            "clip_audio_volume": cfg.get("clip_audio_volume"),
            "clip_audio_ducking_enabled": cfg.get("clip_audio_ducking_enabled"),
        },
